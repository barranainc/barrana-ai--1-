...
const CITY_DATA: Record<string, { city: string; region: string; industries: string[]; intro: string }> = {
  "ai-automation-toronto": { city: "Toronto", region: "Toronto, ON", industries: ["Immigration Consultants", "Accounting Firms", "Law Firms", "Contractors", "Healthcare Clinics", "Real Estate Professionals"], intro: "Toronto's small business community is one of the most competitive in Canada. Barrana.ai helps Toronto-based service businesses automate their operations so they can compete on service quality, not just price." },
  "ai-automation-vaughan": { city: "Vaughan", region: "Vaughan, ON", industries: ["Immigration Consultants", "Accounting Firms", "Contractors", "Healthcare Clinics", "Real Estate Professionals"], intro: "Vaughan is home to a large and growing small business community, particularly in professional services and construction. Barrana.ai helps Vaughan businesses automate lead response, client intake, document collection, and scheduling." },
  ...
  "ai-automation-scarborough": { city: "Scarborough", region: "Scarborough, Toronto, ON", industries: ["Immigration Consultants", "Accounting Firms", "Healthcare Clinics", "Contractors", "Real Estate Professionals"], intro: "Scarborough's diverse small business community serves one of the most multicultural populations in Canada. Barrana.ai helps Scarborough service businesses automate lead response, client intake, and document collection workflows." },
        ...
        <section className="hero-light pt-24 pb-16">
          <div className="container">
            ...
            <div className="max-w-3xl">
              ...
              <h1 className="font-extrabold mb-4" style={{ color: "#1F2937" }}>AI Automation for Small Business in {cityData.city}</h1>
          ...
          <div className="container">
            <div className="max-w-3xl">
              <div className="aeo-block mb-10">
                ...
                <p>Barrana.ai serves small and medium businesses in {cityData.city} with 2 to 50 staff who rely on client relationships and need to handle higher inquiry volumes without adding administrative staff.</p>
              </div>
