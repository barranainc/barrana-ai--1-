...
const articles = [
  { slug: "lead-automation", title: "Lead Response Automation for Small Business", description: "How automated lead response systems work, why response time determines conversion, and what a complete lead automation system looks like for a GTA service business.", tag: "Lead Automation", readTime: "8 min read" },
  ...
  { slug: "ai-agents-for-small-business", title: "AI Agents for Small Business: What They Are and What They Do", description: "A practical explanation of AI agents for small business owners. What they are, what they can and cannot do, and how they differ from chatbots and simple automations.", tag: "AI Agents", readTime: "7 min read" },
  { slug: "workflow-automation-explained", title: "Workflow Automation Explained: A Guide for Small Business Owners", description: "What workflow automation is, how it works, what it costs, and how to evaluate whether it is right for your business. Written for operators, not developers.", tag: "Workflow Automation", readTime: "9 min read" },
  { slug: "top-25-automated-workflows", title: "Top 25 Automated Workflows for Small Business", description: "The 25 most impactful automation workflows for small and medium businesses, organized by function: lead management, client operations, financial processes, and internal coordination.", tag: "Workflows", readTime: "12 min read" },
];
      ...
      <section className="hero-light pt-24 pb-16">
        <div className="container">
          ...
          <div className="max-w-3xl">
            ...
            <h1 className="font-extrabold mb-4" style={{ color: "#1F2937" }}>AI Automation for Small Business: A Practical Knowledge Base</h1>
            <p className="text-lg leading-relaxed" style={{ color: "#6B7280" }}>Practical guides on AI automation for small business owners in Toronto and the GTA. Written for operators, not developers.</p>
          </div>
        </div>
      </section>
