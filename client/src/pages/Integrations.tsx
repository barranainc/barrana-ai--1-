          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            {integrations.map((int) => (
              <Link key={int.slug} href={`/integrations/${int.slug}`} className="card-base group" style={{ textDecoration: "none" }}>
                ...
                <span className="text-xs font-semibold flex items-center gap-1" style={{ color: "#283891" }}>Learn more <svg width="12" height="12" viewBox="0 0 16 16" fill="none"><path d="M3 8h10M9 4l4 4-4 4" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/></svg></span>
              </Link>
            ))}
          </div>
        </div>
