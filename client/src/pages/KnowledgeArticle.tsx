...
const ARTICLES: Record<string, { title: string; tag: string; readTime: string; intro: string; sections: { heading: string; body: string }[] }> = {
  "lead-automation": {
    title: "Lead Response Automation for Service Business",
    tag: "Lead Automation",
    readTime: "8 min read",
    intro: "When a potential client submits a form on your website, every minute that passes without a response reduces the probability of conversion. Studies consistently show that responding within 5 minutes increases conversion rates by up to 9x compared to responding after 30 minutes. For most service businesses, this is structurally impossible without automation.",
    sections: [
      { heading: "Why Response Time Is a Systems Problem", body: "Most business owners understand that fast follow-up matters. The problem is not motivation — it is structure. When the owner is on a job site, in a client meeting, or handling an emergency, lead inquiries sit unanswered. This is not a discipline problem. It is a workflow problem that automation solves." },
  ...
  "ai-agents-for-small-business": {
    title: "AI Agents for Service Business: What They Are and What They Do",
    tag: "AI Agents",
    readTime: "7 min read",
    intro: "The term 'AI agent' is used loosely in marketing materials. For business owners, what matters is a practical understanding of what AI agents can do in your specific operational context — not a theoretical definition.",
    sections: [
      { heading: "What an AI Agent Is (Practically)", body: "An AI agent is a software system that can take a goal, break it into steps, use tools to complete those steps, and adapt based on the results. In a service business context, this means: receiving an inquiry, determining what type of inquiry it is, taking the appropriate action (sending a form, booking an appointment, escalating to a human), and logging the result." },
      ...
      { heading: "Practical Applications for GTA Service Businesses", body: "The most effective AI agent applications for service businesses in Toronto and the GTA include: 24/7 lead response and qualification; after-hours inquiry handling; appointment booking and rescheduling; document request and follow-up; FAQ responses for common client questions; and status update responses for existing clients." },
    ],
  },
  "workflow-automation-explained": {
    title: "Workflow Automation Explained: A Guide for Business Owners",
    tag: "Workflow Automation",
    readTime: "9 min read",
    intro: "Workflow automation means using software to automatically complete tasks that would otherwise require manual effort from your team. For a service business, this typically means connecting the tools you already use so that information flows between them automatically — without anyone copying, pasting, emailing, or manually updating records.",
    sections: [
      ...
      { heading: "What Workflow Automation Costs", body: "The cost of workflow automation has two components: the implementation cost (designing, building, and testing the automation system) and the ongoing platform cost (monthly fees for the automation tools). Implementation costs depend on complexity. Platform costs for service businesses typically range from $20 to $200 per month depending on usage volume." },
  ...
  "top-25-automated-workflows": {
    title: "Top 25 Automated Workflows for Service Business",
    tag: "Workflows",
    readTime: "12 min read",
    intro: "The 25 most impactful automation workflows for service businesses, organized by function. These are the workflows that consistently deliver the highest ROI for GTA service businesses.",
    sections: [
